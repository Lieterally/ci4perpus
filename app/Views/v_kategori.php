 ...
 <div class="container-fluid">
     ...
     <div class="card shadow mb-4">
         ...
         <div class="p-3">
             <a href="" class="btn btn-primary" data-toggle="modal" data-target="#add_kategori">+Tambah Kategori</a>
         </div>
                         ...
                         <tr>
                             ...
                             <td>
                                 <button class="btn btn-warning" data-toggle="modal"
                                     data-target="#edit_kategori<?=$value['id_kategori']; ?>"><i
                                         class="fa-solid fa-pen-to-square"></i></button>
                                 <button class="btn btn-danger" data-toggle="modal"
                                     data-target="#remove_kategori<?=$value['id_kategori']; ?>"><i
                         ...
                         <div class="col-md">
                             <div class="form-group">
                                 ...
                                 <input type="text" name="nama_kategori" class="form-control"
                                     value="<?=$value['nama_kategori']; ?>" required>
                             </div>
                         </div>
     ...
     <!-- modal remove-->
     <?php foreach ($kategori as $key => $value) { ?>
     <div class="modal fade" id="remove_kategori<?=$value['id_kategori']; ?>">
         <div class="modal-dialog modal-m">
             <div class="modal-content">
                 <div class="modal-header">
                     <h4 class="modal-title">Tambah Kategori</h4>
                 ...
                 <div class="modal-body pb-0">
                     <h6>Apakah anda yakin ingin menghapus <?=$value['nama_kategori']; ?>?</h6>
                 </div>
                 <!-- /.card-body -->
                 </p>
                 <div class="modal-footer justify-content-between">
                     ...
                     <form action="/Kategori/<?= $value['id_kategori']; ?>" method="POST" class="d-inline">
                         <?= csrf_field(); ?>
...
var element1 = document.getElementById('kategori')
